...
class AppColors {
  ...
  static final Color black = HexColor('#072844');
  static final Color deepBlue = HexColor('#0700CA');
  static final Color red = HexColor('#FF0004');
  static final Color green = HexColor('#007043');
}