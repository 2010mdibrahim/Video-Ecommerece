...
class BillingInformationBuyNowWidget extends StatelessWidget {
  final CheckoutModel checkoutModel;
  BillingInformationBuyNowWidget({super.key, required this.checkoutModel});
  var checkoutController = locator<ReelsController>();
  @override
