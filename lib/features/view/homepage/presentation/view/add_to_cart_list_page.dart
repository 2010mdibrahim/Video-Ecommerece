      ...
      body: GetBuilder(
          ...
          builder: (homeController) {
            return Obx(() => Column(
                  children: [
                    Expanded(
                      child: homeController.isLoading.value == true ? const Center(
                        child: CircularProgressIndicator(),
                      ) : homeController.homeAddToCartModel.value.products?.isEmpty ??
                              false
                          ? Center(
                          ...
                          : ListView(
                        children: homeController.homeAddToCartModel.value.products!.entries.map((entry) {
                                                    ...
                                                    children: [
                                                      InkWell(
                                                          ...
                                                          CustomContainer(
                                                              ...
                                                              "-")),
                                                      5.pw,
                                                      if (product?.productCountIncrement ==
                                                          null)
                                                        CustomContainer(
                                                            value:
                                      ...
                                      onPressed: () async {
                                        homeController
                                            ...
                                            product?.item?.id
                                                .toString() ??
                                                '',
                                            homeController.homeAddToCartModel.value.products);
                                      },
                                      icon: Icon(
                    ...
                    InkWell(
                      // onTap: () {
                      //   var sum = 0;
                      //   homeController.addToCartListModel.value
                      //       ?.forEach((value) {
                      //     sum =
