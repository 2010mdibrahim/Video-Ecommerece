                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            CustomSimpleText(
                              text: "${session.getCommissionBalance}",
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: ListView.builder(
                                  itemCount: homeController.myWalletModel.value.walletHistory?.length,
                                  itemBuilder: (_, index) {
                                    var item = homeController.myWalletModel.value.walletHistory?[index];
                                    return Padding(
                                              ...
                                              children: [
                                                ClipRRect(
                                                  ...
                                                  child:
                                                    ...
                                                    imageUrl:
                                                        "http://erp.mahfuza-overseas.com/trending-house/assets/images/thumbnails/${item?.productThumbnail}",
                                                    height: 40,
                                                    weight: 40,
                                                  ),
                                                ),
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          CustomSimpleText(
                                                            text: homeController.formatDate(item?.updatedAt),
